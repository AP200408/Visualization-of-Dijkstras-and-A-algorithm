...
class PathfindingVisualization:
    def __init__(self, root, canvas_width=600, canvas_height=500):
        ...
        self.algorithm = None  # Variable to track the selected algorithm
        self.red_lines = []
    ...
    def setup_ui(self):
        ...
        dijkstra_button = tk.Button(self.root, text="Run Dijkstra", command=self.run_dijkstra, font=("Helvetica", 12), bg="#4caf50", fg="white")
        dijkstra_button.pack()

        astar_button = tk.Button(self.root, text="Run A*", command=self.run_astar, font=("Helvetica", 12), bg="#2196f3", fg="white")
        astar_button.pack()
    ...
    def run_algorithm(self):
        ...
        path, distance = self.execute_algorithm(start_node, end_node)
    ...
    def execute_algorithm(self, start, end):
        ...
        while not open_set.empty():
            ...
            for neighbor, weight in self.get_neighbors(node):
                if neighbor not in closed:
                    open_set.put((cost + weight, neighbor, path))
        ...
        while not open_set.empty():
            ...
            for neighbor, weight in self.get_neighbors(node):
                if neighbor not in closed:
                    ...
                    open_set.put((f_cost, neighbor, path))
...
if __name__ == "__main__":
    root = tk.Tk()
    app = PathfindingVisualization(root)
    root.mainloop()
